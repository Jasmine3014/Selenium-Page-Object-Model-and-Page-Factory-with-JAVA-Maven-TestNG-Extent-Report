...
public class CreateUserTest extends CommonMethod{
	...
	public void OpenURL() throws InterruptedException {
		...
		ParentTest = report.createTest("<p style=\"color:#FF6000; font-size:13px\"><b>Create New User</b></p>").assignAuthor("QA Team").assignDevice("Windows");
